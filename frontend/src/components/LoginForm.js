    ...
    <main className={classes.content}>
      ...
      <Grid container direction="column" justify="center" alignItems="center">
        ...
        <TextField
          ...
          helperText={passwordFailed ? 'Password must not by empty' : ''}
          name="password"
          label="Password"
          variant="outlined"
          margin="normal"
        ...
        <Typography style={{ padding: 5, fontSize: 16 }}>
          I forgot{' '}
          <Mlink className={classes.link} component={Link} to="/">
            my password
          </Mlink>
        </Typography>
        <Typography style={{ padding: 30, fontSize: 20 }}>
          Don't have a Lorelines account?{' '}
          <Mlink className={classes.link} component={Link} to="/Register">
            Click here
          </Mlink>
        </Typography>
      </Grid>
